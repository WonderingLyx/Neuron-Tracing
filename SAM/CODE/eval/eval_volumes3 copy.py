...
if __name__ == "__main__":
    ...
    parser.add_argument('--root', type=str, default='/mnt/40B2A1DBB2A1D5A6/lyx/project/MedSam2/SAM-Unet/old/predicts', help='Path to the directory containing predicted .tiff files')
