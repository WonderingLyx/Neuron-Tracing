...
parser.add_argument("--resize_radio", type=float, default=1.0)  # drive 2 15 same with neuron #! Neuro-big resize=1

parser.add_argument(
    "--pretrained_path",
    type=str,
    default="/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/Results/Neuron2d_big/model/model2d_0/10_32/epoch_10_batchsize_32_best.pth",
...
parser.add_argument(
    "--save_path",
    default="/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/Results/Neuron2d_big/Predicts",
...
class Model(nn.Module):
    def __init__(self, in_channel, out_channel, freeze_net=False, weights_path=None, device=None, device_ids=[0]):
        ...
        self.model = SAM2_Net_2D(in_channel, out_channel)
...
def test(args, device, device_ids=[0]):
    ...
    for test_img_dir in test_image:
        ...
        path = os.path.join(args.save_path, image_name + ".pro.skl.tif")
