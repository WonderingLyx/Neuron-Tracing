...
parser.add_argument('--dataset_name', default = 'single_neuron_3d',help='datasets name')
parser.add_argument('--dataset_img_path', default = '/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/single_neuron_3d/dataset/training_datasets/',help='Train datasets image root path')
parser.add_argument('--dataset_img_test_path', default = '/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/single_neuron_3d/dataset/test_datasets/',help='Train datasets label root path')
parser.add_argument('--test_data_path', default = '/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/single_neuron_3d/test/images/',help='Test datasets root path')
...
parser.add_argument('--model_save_dir', default='/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/Results/single_neuron_3d/model/model_',help='save path of trained model')
parser.add_argument('--log_save_dir', default='/mnt/40B2A1DBB2A1D5A6/lyx/TMP/neuron_tracing_from4090_1/Reference/DeepBranchTracer-new/DeepBranchTracer-main/data/Results/single_neuron_3d/log/log_',help='save path of trained log')
