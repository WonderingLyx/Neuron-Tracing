...
class Images_Dataset_folder(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        node_label_exist = self.lx_exist(l_exist_new.astype(np.int64))
        ...
        node_label_vector1_bin = self.lx_vector1_bin(l_vector1_bin_new.astype(np.int64))
        node_label_vector2_bin = self.lx_vector2_bin(l_vector2_bin_new.astype(np.int64))
        node_label_vector3_bin = self.lx_vector3_bin(l_vector3_bin_new.astype(np.int64))
